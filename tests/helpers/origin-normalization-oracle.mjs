// Frozen pre-optimization oracle from the supplied 2026-09-08 handoff ZIP.
// Intentionally retains the original normalize/serialize/merge path; do not optimize.
import { canonicalAddress, deepFreeze, jsonSafe, stableStringify, validateCanonicalIdentityNumbers } from '../../js/core/identity/index.js';
