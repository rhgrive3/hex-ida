...
// SET_SYMBOL_TRAILING_FLAGS_IMM "ab"; SET_TYPE_IMM pointer; SET_SEGMENT_AND_OFFSET_ULEB seg=0 off=0; DO_BIND; DONE
const STREAM_AB = Uint8Array.from([0x40, 0x61, 0x62, 0x00, 0x51, 0x70, 0x00, 0x90, 0x00]);
...
test('#6303 retained import name is charged again on bind output', () => {
  ...
  const stream = Uint8Array.from([0x40, 0x61, 0x62, 0x00, 0x51, 0x70, 0x00, 0x90, 0x40, 0x61, 0x62, 0x00, 0x90, 0x00]);
