...
export const ALIAS_QUERIES_V2 = Object.freeze([
  ...
  // Escape categories
  { id: 'v2-frame-non-escaping', fixture: 'frame-non-escaping', left: 'node_st_slot', right: 'node_st_arg', truth: 'may', truthSource: 'deterministic-fixture-construction', proofClass: 'escape', category: 'non-escaped-object' },
  ...
  { id: 'v2-tls-vs-stack', fixture: 'tls-vs-stack', left: 'node_st_tls_root', right: 'node_st_sp_root', truth: 'may', truthSource: 'authoritative-spec-relation', proofClass: 'tls', category: 'tls-identities-vs-stack' },
]);
