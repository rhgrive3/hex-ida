...
// Matrix assembly retains language verdicts, PAC metadata, exact identities and deterministic round-trip.
{
  ...
  assert.equal(missingReaderResult.completeness.present, false, 'review reproducer reaches false absence outside the issued factory');
  ...
  assert.equal(copiedObjcResult.completeness.present, false);
