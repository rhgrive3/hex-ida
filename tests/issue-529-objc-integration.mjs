...
const model = {
  ...
  classes: [
    ...
    { name: 'KnownUnrelated', addr: 0x1030n, superName: null, protocols: [], methods: [], classMethods: [] },
  ],
  categories: [{
...
const unrelatedReceiver = resolveObjcDispatch(index, { receiverType: 'KnownUnrelated', selector: 'debugName' });
