...
test('AI capability executor remains explicitly owned by Phase 12 integration', () => {
  const manifest = loadManifest();
  assert.ok(
    manifest.lanes['p12-integration'].includes('js/ai/capabilities/executor.js'),
    'the AI capability executor must remain explicitly covered by Phase 12 aggregate ownership',
  );
