...
function activeMarker(overrides = {}) {
  const value = {
    ...
    pause:{ observed:true, continueAccepted:true, stopAccepted:true, runningObserved:true, runningEvidence:'continue-success+register-progress', stoppedObserved:true, executionAdvanced:true, processId:1, threadId:2, registers:{ pc:'0x1004', sp:'0x2000', x0:'0x10' }, state:'stopped' },
