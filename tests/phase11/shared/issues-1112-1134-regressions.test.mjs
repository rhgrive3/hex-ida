...
const typedCall = parseWasm(wasm(
  section(1,[0x02,0x60,0x01,0x7f,0x01,0x7f,0x60,0x00,0x01,0x7f]),
  section(3,[0x02,0x00,0x01]),
  section(10,[0x02,0x04,0,0x20,0x00,0x0b,0x06,0,0x41,0x07,0x10,0,0x0b])
));
