...
test('#7706 nested and generic element identities stay lossless', () => {
  ...
  // with TypeDef#1 declared via the fixture's single TypeDef row. Note: the
  // GENERICINST argument list is consumed but the generic definition token is
  // the only decoded identity on this branch (#7609 covers generic-argument
  // retention for call results; this case pins that SZARRAY wrapping itself
  // stays lossless and the call remains exact).
