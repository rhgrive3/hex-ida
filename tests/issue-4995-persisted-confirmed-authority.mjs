...
// (5) Existing immutability semantics of verified records are retained.
{
  ...
  // Current EvidenceStore reads are owned snapshots (#4436), so assert
  // semantic immutability rather than object-reference identity.
  assert.deepEqual(keepStore.get('keep-1'), verifiedRecord);
