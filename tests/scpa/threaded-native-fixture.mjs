...
export async function threadedNativeFixture(t, { fixture = 'threaded-integer' } = {}) {
  assert.ok(['threaded-integer', 'threaded-call-memory', 'dispatch-table', 'arm64-real-byte-semantic-holdout', 'arm64-real-byte-fpsimd-atomic-holdout'].includes(fixture), 'owned fixture required');
