...
assert.equal(rename.status, 'pending', 'create() returns a detached display snapshot, not a live record');
...
assert.equal(applied.status, 'pending', 'applying a proposal does not mutate an earlier display snapshot');
