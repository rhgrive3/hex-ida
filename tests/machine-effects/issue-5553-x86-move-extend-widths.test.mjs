...
// Register width matrix, including the operand-size states covered by the
// canonical integer denominator. The 16->16 forms preserve upper RAX, as
// independently checked by move-extension-register-oracle.c on native x86.
