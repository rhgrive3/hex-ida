...
assert.equal(ARM64_ARCHITECTURE.semanticVersion, '7');
assert.equal(ARM64E_ARCHITECTURE.semanticVersion, '7');
...
assert.equal(X86_64_MACHINE_EFFECTS_SEMANTIC_VERSION, '5.2.3-stage2-x86-denominator');
