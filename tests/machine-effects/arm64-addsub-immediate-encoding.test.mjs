...
for (const [mnemonic, operands, reason] of [
  ...
  ['adc','x0, x1, x2, lsl #1','arm64-adc-register-modifier-unencodable'],
  ['adcs','w0, w1, w2, lsl #1','arm64-adcs-register-modifier-unencodable'],
  ['sbc','x0, x1, x2, asr #1','arm64-sbc-register-modifier-unencodable'],
  ['sbcs','w0, w1, w2, lsr #1','arm64-sbcs-register-modifier-unencodable'],
  ['ngc','x0, x1, lsl #1','arm64-ngc-register-modifier-unencodable'],
  ['ngcs','w0, w1, lsl #1','arm64-ngcs-register-modifier-unencodable'],
