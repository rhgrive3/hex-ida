...
// Repeated anonymous variables are distinct SSA values. Reuse the node when
// this fixture intentionally models one value observed twice.
const xorX = v('x');
assert.equal(printExpression(rw(expr.binary('xor', xorX, xorX, 32, false))), '0');
