...
- Current remote head before this checkpoint update: `origin/fix/issues-appmap-class-method-calls-6188` at `db7d09331697eedd17cb1149e784746c4a20c8a4`
...
- [x] Candidate tree `739d08c2849e8034ba2943997dbdcbbe7477814f` passed focused regression, lint, and the AppMap compatibility regression; Phase 4 reached 33-file plus independent-verification PASS before the known pristine-main ownership-contract failure.
- [x] Created one owner PR for #6188: #6492.
