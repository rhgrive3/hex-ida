...
| HEX-ME-01 | VERIFYING | PARTIAL | Sol | `specs/004-independent-machine-effects-oracle`; `specs/005-machine-effects-evidence-breadth` | Oracle T001–T036 and Phase 2 T009–T018 complete locally; oracle T037–T039 and Phase 2 T019–T023 open | `work/me01-full-clean` | C0-01; current-main `apply_damage` and active Phase 8 SCCP reconciliation | deterministic offline oracle/report schemas, explicit gap accounting, A2 preservation, strict undefined-result contract/transport, both v1 projections, SCCP fail-closed consumption, and raw-encoding/profile-validated x86 BSF/BSR producer | local fixture/schema, real Capstone decoder, MachineEffects/Semantic V2/Phase 8 tests; no current external regeneration | current herd7/Isla/Sail/QEMU/hardware evidence, integration-owned generated artifact, current-main SCCP/`apply_damage` reconciliation, exact-head/candidate-tree/CI/live-main proof | — | — | — | unavailable/unsupported rows, malformed descriptors, and absent current evidence must not authorize exact scalar, corpus, or release facts | producer and local transport implemented; release remains PARTIAL with no completion claim |
