...
| HEX-ME-01 | REMAINING | PARTIAL | Sol | — | — | — | C0-01 | Phase 2 adds pinned Isla Armv8.5 footprint, herdtools7 7.58 five-ordering AArch64 litmus outcomes, Sail RISC-V 0.13.1 traces, separately identified QEMU AArch64/RV64 executions, strict generated-manifest provenance/denominator guards, and end-to-end undefined-result masks; incomplete evidence cannot authorize release exactness | claim-local formal/QEMU breadth plus conservative mask transport; four-profile A2 denominator preserved | physical-hardware triangulation, complete arm64e PAC and modern x86_64 formal evidence, RV64 relaxed-memory outcomes, and architecture-wide observable coverage remain absent | — | — | — | unsupported profiles and non-generated evidence remain explicit non-pass; no architecture-wide exact claim | none |
