...
| HEX-ME-01 | VERIFYING | PARTIAL | Sol | `specs/004-independent-machine-effects-oracle` | T001–T036 complete; T037–T039 open | `work/me01-oracle-clean` | C0-01; review T017 real x86 producer; review T018 current-main `apply_damage` | deterministic offline oracle/report schemas, explicit gap accounting, A2 preservation, and claim-local formal/memory evidence validation; component ownership rejects committed generated evidence | oracle-only source and unit fixtures; no current external regeneration | current herd7/Isla/Sail/QEMU/hardware evidence, integration-owned generated artifact, current-main dependency reconciliation, exact-head/candidate-tree/CI/live-main proof | — | — | — | unavailable/unsupported rows and absent current evidence must not authorize corpus or release exactness | T017 and T018 remain open; no completion claim |
