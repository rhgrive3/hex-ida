...
export const CROSS_LANE_ROUTES = Object.freeze({
  ...
  "codex/consolidate-arm64-repairs-20260913": Object.freeze([
    ...
    "tests/phase7/debug/issue-4643-incomplete-debug-type-soft-not-hard.test.mjs",
    "tests/phase7/debug/issue-4652-dwarf2-ref-addr-width.test.mjs",
  ...
  // The agy follow-up is a short-lived multi-lane integration candidate. The
  // Phase 8 subset remains exact; every non-Phase-8 path is listed here so
  // this route cannot turn into a general ownership exemption.
