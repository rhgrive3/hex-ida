...
export const EVIDENCE_ORDERINGS = Object.freeze(['relaxed', 'acquire', 'release', 'acq-rel', 'seq-cst', 'unknown']);
...
function normalizeSource(value) {
  ...
  if (!source.independentFromProduction) fail('production-derived-evidence');
