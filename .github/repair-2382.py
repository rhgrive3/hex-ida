...
export function swiftCallingConvention"""
s = s[:m.start()] + new_resolve + s[m.end():]
path.write_text(s)
...
Path('tests/issue-2382-swift-completeness.mjs').write_text(r'''import assert from 'node:assert/strict';
