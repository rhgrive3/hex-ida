...
export function createRuntimeAddressResolution(input = {}) {
  ...
  if (typeof state !== 'string' || !RESOLUTION_STATES.includes(state)) throw new DebugAdapterError('invalid-runtime-resolution-state', 'runtime address resolution state must be a supported string');
