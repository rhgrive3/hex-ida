...
// The solver-backed Phase 8 plan is kept in its own module so the existing
// pass-result validation substrate remains backwards compatible while the
// proof-gated scalar/e-graph path is exposed through the established entry
// point.
export {
  PROOF_REWRITE_PASS,
