...
export class InvestigationSessionStore {
  ...
  async create(input) {
    ...
    // The reservation is synchronous, but all durable work and publication
    // join the same queue as update/delete. Release it inside the operation
    // so the next queued mutation can observe the settled create result.
