...
function createSandboxMonitor(options) {
  ...
  function onMessage(event) {
    ...
    if (!isEmbedGeneration(data.generation, expectedGeneration)) return;
    if (!isEmbedSandboxToken(data.sandboxToken, token)) return;
