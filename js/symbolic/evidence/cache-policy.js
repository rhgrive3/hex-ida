...
function requireIdentityText(value, label) {
  // Exact typed identity (#4660): a proof cache key / verifier fingerprint must
  // bind primitive-string identity. String(structuredValue) laundered ['bin-A']
  // into 'bin-A', so a malformed binary/analysis/assumption identity could alias
  // another proof's cache key. Reject instead of coercing.
