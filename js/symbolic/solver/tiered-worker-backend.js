...
function defaultWorkerFactory() {
  ...
  return new globalThis.Worker(new URL('./tiered-worker-entry.js', import.meta.url), { type: 'module' });
}
...
export class TieredWorkerSolverBackend extends SolverBackend {
  constructor(options = {}) {
    const id = options.id ?? TIERED_WORKER_BACKEND_ID;
    const version = options.version ?? TIERED_WORKER_BACKEND_VERSION;
