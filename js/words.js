...
(function (global) {
  ...
  function isBr(w) { return masked(w, 0xfffffc1f) === 0xd61f0000 || masked(w, 0xfffff81f) === 0xd61f081f || masked(w, 0xffe0f800) === 0xd7000800; }
  ...
  function isIndirectCall(w) {
    ...
    if (masked(w, 0xffe0f800) === 0xd7200800) return true;         // blraa / blrab
    return false;
  }
