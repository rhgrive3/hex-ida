...
// contract:
//   * it is producer-owned state — the semantic IR keeps a live `defUse`
//     closure and the compatibility model keeps row/address/symbol callbacks —
//     so publishing it hands consumers a handle on live analysis state, and
