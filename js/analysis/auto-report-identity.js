const INSTALL_VERSION = 'auto-report-identity/v1';
...
export function installAutoReportIdentityBoundary(app) {
  ...
  const state = { bound:null, stale:null };
  STATE.set(app, state);
  Object.defineProperty(app, 'autoReport', {
    ...
    get() {
      ...
      if (!sameIdentity(state.bound.identity, liveIdentity(app))) {
    ...
    set(value) {
      state.bound = value == null ? null : bindValue(app, value);
