...
function validateReturnProvenance(value) {
  ...
  optionalIndex(value.returnIndex, 'function-summary-invalid-return-provenance-return-index');
  optionalInteger(value.offset, 'function-summary-invalid-return-provenance-offset');
