...
export function parsePattern(source) {
  if (source && typeof source === 'object') { assertBoundedIdentityInput(source, 'pattern-identity-input-too-large'); return deepFreeze({ languageVersion: PATTERN_LANGUAGE_VERSION, ast: source, source: stableDigest(source) }); }
