...
import { createArm64EffectContext, immediateOf, strictAddressInput } from './common.js';
...
function validAddressEncoding(instruction, ops) {
  ...
  const target = strictAddressInput(instruction?.pcRelTarget ?? immediateOf(targetOperand));
