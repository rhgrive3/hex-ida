...
function lookupId(value) { return required(value, 'evidence-invalid-node-id'); }
...
export class EvidenceGraph {
  ...
  getNode(id) { return this.#nodes.get(lookupId(id)) || null; }
  hasNode(id) { return this.#nodes.has(lookupId(id)); }
