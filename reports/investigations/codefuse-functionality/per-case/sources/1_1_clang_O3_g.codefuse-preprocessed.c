...
/* raw-function-text: address=3152 name=loop_break state=PASS completeness=complete */
...
/* raw-function-text: address=3208 name=unknown state=PARTIAL completeness=partial */
void sub_C88(void)
{
 return;
}

/* raw-function-text: address=3216 name=unknown state=PARTIAL completeness=partial */
void sub_C90(void)
{
 return;
}

/* raw-function-text: address=3224 name=unknown state=PARTIAL completeness=partial */
void sub_C98(void)
{
 return;
}

/* raw-function-text: address=3232 name=loop_continue state=PASS completeness=complete */
...
/* raw-function-text: address=3404 name=goto_forward state=PASS completeness=complete */
void goto_forward(void)
{
 return;
}

/* raw-function-text: address=3424 name=goto_backward state=PASS completeness=complete */
...
/* raw-function-text: address=3580 name=ternary_op state=PASS completeness=complete */
void ternary_op(void)
{
 return;
}

/* raw-function-text: address=3592 name=test_control_flow_l1 state=PASS completeness=complete */
...
/* raw-function-text: address=4052 name=loop_multi_exit state=PASS completeness=complete */
...
/* raw-function-text: address=4108 name=infinite_loop state=PASS completeness=complete */
...
/* raw-function-text: address=4152 name=multi_return state=PASS completeness=complete */
...
/* raw-function-text: address=4192 name=conditional_return state=PASS completeness=complete */
void conditional_return(void)
{
 return;
}

/* raw-function-text: address=4208 name=duffs_device state=PASS completeness=complete */
...
/* raw-function-text: address=4356 name=loop_complex_cond state=PASS completeness=complete */
...
/* raw-function-text: address=4448 name=loop_modify_var state=PASS completeness=complete */
...
/* raw-function-text: address=4512 name=loop_external_state state=PASS completeness=complete */
...
/* raw-function-text: address=4544 name=recursion_factorial state=PASS completeness=complete */
...
/* raw-function-text: address=4712 name=tail_recursion state=PASS completeness=complete */
...
/* raw-function-text: address=4868 name=indirect_recursion_a state=PASS completeness=complete */
...
/* raw-function-text: address=4956 name=call_func_ptr state=PASS completeness=complete */
...
/* raw-function-text: address=4968 name=call_func_ptr_array state=PASS completeness=complete */
...
/* raw-function-text: address=5004 name=double_value state=PASS completeness=complete */
void double_value(void)
{
 return;
}

/* raw-function-text: address=5012 name=triple_value state=PASS completeness=complete */
void triple_value(void)
{
 return;
}

/* raw-function-text: address=5020 name=call_virtual_func state=PASS completeness=complete */
void call_virtual_func(void)
{
 return;
}

/* raw-function-text: address=5028 name=process_with_callback state=PASS completeness=complete */
...
/* raw-function-text: address=5132 name=test_control_flow_l2 state=PASS completeness=complete */
...
/* raw-function-text: address=5564 name=non_local_jump state=PASS completeness=complete */
...
/* raw-function-text: address=5672 name=cpp_exception state=PASS completeness=complete */
void cpp_exception(void)
{
 return;
}

/* raw-function-text: address=5700 name=large_jump_table state=PASS completeness=complete */
...
/* raw-function-text: address=5740 name=op_add state=PASS completeness=complete */
void op_add(void)
{
 return;
}

/* raw-function-text: address=5748 name=op_sub state=PASS completeness=complete */
void op_sub(void)
{
 return;
}

/* raw-function-text: address=5756 name=op_mul state=PASS completeness=complete */
void op_mul(void)
{
 return;
}

/* raw-function-text: address=5764 name=op_div state=PASS completeness=complete */
void op_div(void)
{
 loc_1684:
...
/* raw-function-text: address=5784 name=op_mod state=PASS completeness=complete */
void op_mod(void)
{
 loc_1698:
...
/* raw-function-text: address=5808 name=op_and state=PASS completeness=complete */
void op_and(void)
{
 return;
}

/* raw-function-text: address=5816 name=op_or state=PASS completeness=complete */
void op_or(void)
{
 return;
}

/* raw-function-text: address=5824 name=op_xor state=PASS completeness=complete */
void op_xor(void)
{
 return;
}

/* raw-function-text: address=5832 name=op_shl state=PASS completeness=complete */
void op_shl(void)
{
 return;
}

/* raw-function-text: address=5840 name=op_shr state=PASS completeness=complete */
void op_shr(void)
{
 return;
}

/* raw-function-text: address=5848 name=conditional_func_ptr state=PASS completeness=complete */
...
/* raw-function-text: address=5896 name=state_machine state=PASS completeness=complete */
...
/* raw-function-text: address=5996 name=fsm_func_table state=PASS completeness=complete */
...
/* raw-function-text: address=6028 name=state_idle state=PASS completeness=complete */
void state_idle(void)
{
 return;
}

/* raw-function-text: address=6040 name=state_processing state=PASS completeness=complete */
void state_processing(void)
{
 return;
}

/* raw-function-text: address=6064 name=state_done state=PASS completeness=complete */
void state_done(void)
{
 return;
}

/* raw-function-text: address=6072 name=state_error state=PASS completeness=complete */
void state_error(void)
{
 return;
}

/* raw-function-text: address=6088 name=computed_goto state=PASS completeness=complete */
...
/* raw-function-text: address=6128 name=unknown state=PARTIAL completeness=partial */
void sub_17F0(void)
{
 return;
}

/* raw-function-text: address=6136 name=unknown state=PARTIAL completeness=partial */
void sub_17F8(void)
{
 return;
}

/* raw-function-text: address=6144 name=unknown state=PARTIAL completeness=partial */
void sub_1800(void)
{
 return;
}

/* raw-function-text: address=6152 name=obfuscated_cf state=PASS completeness=complete */
void obfuscated_cf(void)
{
 return;
}

/* raw-function-text: address=6160 name=opaque_predicate state=PASS completeness=complete */
void opaque_predicate(void)
{
 return;
}

/* raw-function-text: address=6168 name=overlapped_code state=PASS completeness=complete */
void overlapped_code(void)
{
 return;
}

/* raw-function-text: address=6196 name=test_control_flow_l3 state=PASS completeness=complete */
...
/* raw-function-text: address=6444 name=main state=PASS completeness=complete */
void main(void)
{
