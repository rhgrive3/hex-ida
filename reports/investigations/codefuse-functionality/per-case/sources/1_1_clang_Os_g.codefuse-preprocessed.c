...
/* raw-function-text: address=3204 name=loop_continue state=PASS completeness=complete */
...
/* raw-function-text: address=3332 name=goto_forward state=PASS completeness=complete */
void goto_forward(void)
{
 return;
}

/* raw-function-text: address=3352 name=goto_backward state=PASS completeness=complete */
...
/* raw-function-text: address=3476 name=ternary_op state=PASS completeness=complete */
void ternary_op(void)
{
 return;
}

/* raw-function-text: address=3488 name=test_control_flow_l1 state=PASS completeness=complete */
...
/* raw-function-text: address=3948 name=loop_multi_exit state=PASS completeness=complete */
...
/* raw-function-text: address=4028 name=infinite_loop state=PASS completeness=complete */
...
/* raw-function-text: address=4072 name=multi_return state=PASS completeness=complete */
...
/* raw-function-text: address=4112 name=conditional_return state=PASS completeness=complete */
void conditional_return(void)
{
 return;
}

/* raw-function-text: address=4128 name=duffs_device state=PASS completeness=complete */
...
/* raw-function-text: address=4260 name=loop_complex_cond state=PASS completeness=complete */
...
/* raw-function-text: address=4344 name=loop_modify_var state=PASS completeness=complete */
...
/* raw-function-text: address=4404 name=loop_external_state state=PASS completeness=complete */
...
/* raw-function-text: address=4436 name=recursion_factorial state=PASS completeness=complete */
...
/* raw-function-text: address=4572 name=tail_recursion state=PASS completeness=complete */
...
/* raw-function-text: address=4708 name=indirect_recursion_a state=PASS completeness=complete */
...
/* raw-function-text: address=4792 name=call_func_ptr state=PASS completeness=complete */
...
/* raw-function-text: address=4804 name=call_func_ptr_array state=PASS completeness=complete */
...
/* raw-function-text: address=4840 name=double_value state=PASS completeness=complete */
void double_value(void)
{
 return;
}

/* raw-function-text: address=4848 name=triple_value state=PASS completeness=complete */
void triple_value(void)
{
 return;
}

/* raw-function-text: address=4856 name=call_virtual_func state=PASS completeness=complete */
void call_virtual_func(void)
{
 return;
}

/* raw-function-text: address=4864 name=process_with_callback state=PASS completeness=complete */
...
/* raw-function-text: address=4952 name=test_control_flow_l2 state=PASS completeness=complete */
...
/* raw-function-text: address=5496 name=non_local_jump state=PASS completeness=complete */
...
/* raw-function-text: address=5592 name=cpp_exception state=PASS completeness=complete */
void cpp_exception(void)
{
 return;
}

/* raw-function-text: address=5620 name=large_jump_table state=PASS completeness=complete */
...
/* raw-function-text: address=5660 name=op_add state=PASS completeness=complete */
void op_add(void)
{
 return;
}

/* raw-function-text: address=5668 name=op_sub state=PASS completeness=complete */
void op_sub(void)
{
 return;
}

/* raw-function-text: address=5676 name=op_mul state=PASS completeness=complete */
void op_mul(void)
{
 return;
}

/* raw-function-text: address=5684 name=op_div state=PASS completeness=complete */
void op_div(void)
{
 loc_1634:
...
/* raw-function-text: address=5704 name=op_mod state=PASS completeness=complete */
void op_mod(void)
{
 loc_1648:
...
/* raw-function-text: address=5728 name=op_and state=PASS completeness=complete */
void op_and(void)
{
 return;
}

/* raw-function-text: address=5736 name=op_or state=PASS completeness=complete */
void op_or(void)
{
 return;
}

/* raw-function-text: address=5744 name=op_xor state=PASS completeness=complete */
void op_xor(void)
{
 return;
}

/* raw-function-text: address=5752 name=op_shl state=PASS completeness=complete */
void op_shl(void)
{
 return;
}

/* raw-function-text: address=5760 name=op_shr state=PASS completeness=complete */
void op_shr(void)
{
 return;
}

/* raw-function-text: address=5768 name=conditional_func_ptr state=PASS completeness=complete */
...
/* raw-function-text: address=5816 name=state_machine state=PASS completeness=complete */
...
/* raw-function-text: address=5916 name=fsm_func_table state=PASS completeness=complete */
...
/* raw-function-text: address=5948 name=state_idle state=PASS completeness=complete */
void state_idle(void)
{
 return;
}

/* raw-function-text: address=5960 name=state_processing state=PASS completeness=complete */
void state_processing(void)
{
 return;
}

/* raw-function-text: address=5984 name=state_done state=PASS completeness=complete */
void state_done(void)
{
 return;
}

/* raw-function-text: address=5992 name=state_error state=PASS completeness=complete */
void state_error(void)
{
 return;
}

/* raw-function-text: address=6008 name=computed_goto state=PASS completeness=complete */
...
/* raw-function-text: address=6048 name=unknown state=PARTIAL completeness=partial */
void sub_17A0(void)
{
 return;
}

/* raw-function-text: address=6056 name=unknown state=PARTIAL completeness=partial */
void sub_17A8(void)
{
 return;
}

/* raw-function-text: address=6064 name=unknown state=PARTIAL completeness=partial */
void sub_17B0(void)
{
 return;
}

/* raw-function-text: address=6072 name=obfuscated_cf state=PASS completeness=complete */
void obfuscated_cf(void)
{
 return;
}

/* raw-function-text: address=6080 name=opaque_predicate state=PASS completeness=complete */
void opaque_predicate(void)
{
 return;
}

/* raw-function-text: address=6088 name=overlapped_code state=PASS completeness=complete */
void overlapped_code(void)
{
 return;
}

/* raw-function-text: address=6116 name=test_control_flow_l3 state=PASS completeness=complete */
...
/* raw-function-text: address=6364 name=main state=PASS completeness=complete */
void main(void)
{
