...
/* raw-function-text: address=2612 name=__dollar_x state=PASS completeness=complete */
...
/* raw-function-text: address=2640 name=__dollar_x state=PARTIAL completeness=partial */
uint64 __dollar_x(void)
 loc_A60:
{
