...
import { parseSourceRanges } from '/mnt/workspace/wt-dynsym/js/binary/source-reader.js';
import { parseELF } from '/mnt/workspace/wt-dynsym/js/binary/index.js';
...
try {
 ...
 console.log("ok", img.metadata.programDynamicDiagnostics, img.metadata.sourceReads, 'syms', img.symbols.length, 'fns', img.functions.length);
